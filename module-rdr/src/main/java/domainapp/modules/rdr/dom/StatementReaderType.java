...
@ToString(of = {"name"})
public class StatementReaderType implements Comparable<StatementReaderType> {

    @Builder
    public StatementReaderType(final String name) {
        setName(name);
    }
    ...
    @javax.jdo.annotations.Column(allowsNull = "false", length = 256)
    @Property(
    		editing = Editing.ENABLED,
    		command = CommandReification.ENABLED,
    		publishing = Publishing.ENABLED
    ...
    public StatementReaderType updateName(
